const forBind = {
    ...
    scanvas : {
        ...
        contFocus : 'xyz-focus',
        vr : ['xyz3d', '[VR]', 'xyzvr','[virtual art space]','xyzvirtual','[photogrammetry]', 'xyzphoto'],
        iframe : ['sujanggo', 'dayeonji', 'necessaries', 'hangang', 'woodtype'],
        feat : ['xyz-features', '다양한 가능성을 확인해 보세요', 'xyzpc', '제안서다운로드', 'download', 'xyzmouse', 'gogo'],
